...
import { useDotState } from '@renderer/context/dot.context'
import { Button } from '../ui/button.component'
import { Input } from '../ui/input.component'
import { Slider } from '../ui/slider.component'
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@renderer/components/ui/tabs.component'
import LocalTab from '@renderer/components/shared/local.component'
import GlobalTab from '@renderer/components/shared/global.component'
...
export default function CanvasSettings() {
  ...
  const { texts, setTexts, setSelectedTextId } = useTextState()
  ...
  return (
    <main className="flex flex-col gap-2 h-full">
      <section className="flex flex-col gap-3 flex-1 overflow-hidden">
        ...
        <>
          <div className="flex flex-row w-full items-center justify-between">
            <span className={`${disabled ? 'text-white/30 select-none' : 'text-text'}`}>
              Размер точки:
            </span>
            <span>{size}</span>
          </div>
        ...
        <>
          <div className="flex flex-row w-full items-center justify-between">
            ...
            <Switch checked={randomJitter} onCheckedChange={setRandomJitter} disabled={disabled} />
          </div>
        </>
      ...
      <section className="flex flex-col w-full gap-2 mb-10">
        <Button
