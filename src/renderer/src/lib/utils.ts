import { Points, ImageData } from '@renderer/types'
...
export function pasteImage(e: ClipboardEvent, setImage: (file: File | null) => void) {
...
export function pointToLineDistance(point: Points, lineStart: Points, lineEnd: Points): number {
...
export function rotatePoint(point: Points, center: Points, angleDegrees: number): Points {
